...
class EMRRecord(models.Model):
    appointment = models.OneToOneField(
        TakeAppointment, on_delete=models.CASCADE, related_name='emr_record'
    )
    patient = models.ForeignKey(
        settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name='patient_emr_records'
    )
    doctor = models.ForeignKey(
        settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name='doctor_emr_records'
    )
