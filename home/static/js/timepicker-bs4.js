...
function updatePicker($input)
{
	...
	let html = '<div class="clock-input' + (clock_enabled ? '' : ' d-none') + '">'
		...
		+ '<div><button type="button" class="btn btn-secondary mx-1 cancel-btn" id = "cancel-btn" data-dismiss="popover" title="Cancel"><i class="fas fa-times fa-fw"></i></button><button type="button" class="btn btn-primary mx-1 submit-btn" title="OK"><i class="fas fa-check fa-fw"></i></button></div>'
		+ '</div>';
