...
from .views import (
    ...
    AppointmentListView,
    ChatRoomView,
    DoctorCalendarEventsAPI,
    DoctorConfirmBookingView,
    DoctorDetailView,
    DoctorInboxView,
    DoctorPageView,
    PatientCancelView,
    PatientDeleteView,
    PatientListView,
    PatientOwnAppointmentListView,
    PatientRescheduleView,
    SubmitReviewView,
    TakeAppointmentView,
    app,
)
...
urlpatterns = [
    ...
    path('doctor/calendar/events/', DoctorCalendarEventsAPI.as_view(), name='doctor-calendar-events'),
    path('doctor/bookings/<int:pk>/confirm/', DoctorConfirmBookingView.as_view(), name='doctor-confirm-booking'),
